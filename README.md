...
- useRouteMatch is used to create a nested route and to access a match without rendering a Route.

2. How would you explain form validation to someone who has never programmed before?
- Form validation is a way to validate a user's input, for example if you have an input for a password and your requirement is at least 5 characters, you want the user to know that, also if another requirement is to have a number in their password, you want the user to know that as well.

3. In 1-2 sentences, define end to end testing.
- E2E testing is a way to test the whole user experience of an app. End-to-end tests focus on User Interface and mimics how a user might interact with an app
